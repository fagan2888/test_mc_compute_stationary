"""
Filename: unittest_test_mc_compute_stationary_sympy.py
Author: Daisuke Oyama

Unittest for mc_compute_stationary_sympy
...
if __name__ == '__main__':
    ...
    vecs = mc_compute_stationary_sympy(P)  # List of eigenvectors
    v = vecs[-1]  # Let's pick the last one
